...
class AuthenticationSignUp extends StatefulWidget {
  ...
  @override
  State<AuthenticationSignUp> createState() => _AuthenticationState();
}

class _AuthenticationState extends State<AuthenticationSignUp> {
  TextEditingController _emailController = TextEditingController();
  TextEditingController _passwrodController = TextEditingController();
  TextEditingController _passwordCoController = TextEditingController();
